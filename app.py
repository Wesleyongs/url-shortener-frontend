...
long_urls = [
    "https://wesleyongs-url-shortener-frontend-app-r9adc3.streamlitapp.com/",
    "https://github.com/Wesleyongs/Govtech-FastAPI",
    "https://wesleyongs-govtech-soccer-frontend-app-42cw17.streamlitapp.com/",
    "http://ec2-13-212-176-7.ap-southeast-1.compute.amazonaws.com/docs",
    "https://github.com/Wesleyongs/url-shortener-frontend",
]
...
input_url = st.text_input(
    "Input long url here",
    placeholder=long_urls[0],
    help="If url exists in db, duplicate entry will not be created, the existing result will instead be returned",
)
